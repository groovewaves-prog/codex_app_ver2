...
| 領域 | 現状 |
|---|---|
| UI | Streamlit。日本語UI。ヒーロー表示、AI Operation Co-Pilot、ステータスバー、送信前チェック、Step 4 の結論ファースト型カードUI、折りたたみ・スクロール表示を実装済み。G-1 の `--sr-*` デザイントークンと共通HTMLコンポーネントを Step 4 v2 で利用開始 |
